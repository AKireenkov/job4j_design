...
insert into rules (role) values ('All');
insert into rules (role) values ('read only');
insert into rules (role) values ('read and write');
...
insert into item (item, state_id, category_id) values ('get access', 1, 2);
insert into item (item, state_id, category_id) values ('remove access', 2, 1);
insert into item (item, state_id, category_id) values ('password reset', 3, 3);

insert into items_for_users (user_id, item_id) values (2, 1);
insert into items_for_users (user_id, item_id) values (2, 3);
insert into items_for_users (user_id, item_id) values (1, 1);
insert into items_for_users (user_id, item_id) values (3, 1);
